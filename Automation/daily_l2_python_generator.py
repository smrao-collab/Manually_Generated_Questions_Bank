...
# PATH LOCATIONS
# ======================================================
BASE = r"D:\Downloads\Manually_Generated_Questions_Bank\Runtime_Question_Files\L2\Python"
EASY_FILE   = os.path.join(BASE, "Easy",   "build_l2_python_easy.json")
MEDIUM_FILE = os.path.join(BASE, "Medium", "build_l2_python_medium.json")
HARD_FILE   = os.path.join(BASE, "Hard",   "build_l2_python_hard.json")
...
TOPICS = {
    "easy": [
        ...
        "Strings", "Lists", "OOP Basics", "Git", "Linux"
    ],
    "medium": [
        "Dictionaries", "Tuples", "Sets", "OOP Concepts", "Functions",
        "Decorators", "Iterators", "Generators", "Exceptions"
    ],
    "hard": [
        "Arrays", "Regular Expressions", "Dictionary Methods",
