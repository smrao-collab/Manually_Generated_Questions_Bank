...
# PATH LOCATIONS
# ======================================================
BASE = r"D:\Downloads\Manually_Generated_Questions_Bank\Runtime_Question_Files\L3\Javascript"

EASY_FILE = os.path.join(BASE, "Easy", "build_l3_js_easy.json")
MEDIUM_FILE = os.path.join(BASE, "Medium", "build_l3_js_medium.json")
HARD_FILE = os.path.join(BASE, "Hard", "build_l3_js_hard.json")
...
def run():
    ...
    print("\n=====================================")
    print(" DAILY L3 JAVASCRIPT SUCCESS")
